        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cytoband_position",
                    models.TextField(
                        blank=True, db_column="Cytoband_position", null=True
                    ),
                ),
            ...
            options={"db_table": "gene_details", "managed": False,},
        ),
        migrations.CreateModel(
            name="GeneHpo",
            fields=[
                ...
                (
                    "alternativeid",
                    models.TextField(blank=True, db_column="AlternativeId", null=True),
                ),
                (
                    "definition",
                    models.TextField(blank=True, db_column="Definition", null=True),
                ),
            ],
            options={"db_table": "gene_hpo", "managed": False,},
        ),
        migrations.CreateModel(
