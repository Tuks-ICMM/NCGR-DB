    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "variant_name",
                    models.CharField(db_column="Variant_name", max_length=150),
                ),
                (
                    "reference_genome",
                    models.TextField(
                ...
                (
                    "transcript_id",
                    models.TextField(blank=True, db_column="Transcript_ID", null=True),
                ),
                (
                    "chromosome",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        db_column="Disease_association_with_ref_allele",
                        null=True,
                    ),
                ),
                (
                    "variant_type",
                    models.TextField(blank=True, db_column="Variant_type", null=True),
                ),
            ],
            options={"db_table": "variant_details", "managed": False,},
        ),
        migrations.CreateModel(
